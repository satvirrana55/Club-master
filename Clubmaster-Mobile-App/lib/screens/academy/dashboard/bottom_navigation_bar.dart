...
class BottomNavigationBarAcademy extends StatefulWidget {
  const BottomNavigationBarAcademy({super.key});

  @override
  State<BottomNavigationBarAcademy> createState() =>
      _BottomNavigationBarAcademyState();
}

class _BottomNavigationBarAcademyState
    extends State<BottomNavigationBarAcademy> {
  int _currentIndex = 0;
