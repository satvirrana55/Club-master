...
class AcademyDrawer extends StatefulWidget {
  const AcademyDrawer({Key? key}) : super(key: key);

  @override
  State<AcademyDrawer> createState() => _AcademyDrawerState();
}

class _AcademyDrawerState extends State<AcademyDrawer> {
  @override
          ...
          Container(
            ...
            child: ListView(
              children: [
                ...
                InkWell(
                    onTap: () {
                      Get.to(() => const LessonPlan());
                    },
                    child: commondrawerContainer(
                        ImageIcon(AssetImage(AppImages.plus)),
                        "Mannage Coaches")),
                SizedBox(
                  height: 20.h,
                ),
                InkWell(
                    ...
                    child: commondrawerContainer(
                        ImageIcon(AssetImage(AppImages.info)),
                        "Mannage Students")),
                SizedBox(
                  height: 20.h,
                ),
