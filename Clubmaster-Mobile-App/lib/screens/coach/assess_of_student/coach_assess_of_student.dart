...
class CoachAssessofStudents extends StatefulWidget {
  const CoachAssessofStudents({super.key});

  @override
  State<CoachAssessofStudents> createState() => _CoachAssessofStudentsState();
}

class _CoachAssessofStudentsState extends State<CoachAssessofStudents> {
  bool val1 = true;
  bool val2 = true;
  bool val3 = false;
  bool val4 = false;
