...
import 'package:sportapp/screens/coach/dashboard/drawer/coach_drawer.dart';
...
class BottomNavigationBarCoach extends StatefulWidget {
  const BottomNavigationBarCoach({super.key});

  @override
  State<BottomNavigationBarCoach> createState() =>
      _BottomNavigationBarCoachState();
}

class _BottomNavigationBarCoachState extends State<BottomNavigationBarCoach> {
  int _currentIndex = 0;
