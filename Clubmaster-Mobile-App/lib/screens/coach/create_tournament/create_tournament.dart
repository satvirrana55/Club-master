...
class CoachCreateTourament extends StatefulWidget {
  const CoachCreateTourament({super.key});

  @override
  State<CoachCreateTourament> createState() => _CoachCreateTouramentState();
}

class _CoachCreateTouramentState extends State<CoachCreateTourament> {
