...
import 'package:sportapp/screens/parents/dashboard/bottom_navigation_bar.dart';

class PerentsRegistraion extends StatefulWidget {
  const PerentsRegistraion({super.key});

  @override
  State<PerentsRegistraion> createState() => _PerentsRegistraionState();
}

class _PerentsRegistraionState extends State<PerentsRegistraion> {
                  ...
                  builder: (context) {
                    return AlertDialog(
                      ...
                      actions: [
                        InkWell(
                          onTap: (() {
                            Get.to(() => BottomNavigationBarParents());
                          }),
                          child: CommonButton(
                            text: 'Ok',
                          ),
